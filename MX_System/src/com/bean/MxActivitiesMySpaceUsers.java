...
public class MxActivitiesMySpaceUsers  implements java.io.Serializable {
	...
	/** minimal constructor */
    public MxActivitiesMySpaceUsers(Integer myspaceId, Integer userId, Integer relateUserId, Date createDate, Date updateDate, Integer state, Integer remainUploadNum, Date imgUpdateDate, Date commentUpdateDate) {
    ...
    /** full constructor */
    public MxActivitiesMySpaceUsers(Integer myspaceId, Integer userId, Integer relateUserId, Date createDate, Date updateDate, Integer state, String others, Integer remainUploadNum, Date imgUpdateDate, Date commentUpdateDate) {
        this.myspaceId = myspaceId;
        this.userId = userId;
        this.relateUserId = relateUserId;
        this.createDate = createDate;
