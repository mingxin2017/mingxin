		...
		<form class="form form-horizontal" id="form-activitySpace-edit">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>活动名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"
						value="${editActivity.activitiesName}" placeholder="活动名称"
						id="activitiesName" name="activitiesName">
				</div>
			</div>
			<div class="row cl">
			...
			<select class="select" name="activityTypes" id="activityTypes" size="1">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">活动人数：</label>
				<div class="formControls col-xs-8 col-sm-9">
					下限<input type="text" name="numLower" id="numLower"
						placeholder="0-10之间" value="${editActivity.lowerLimit}" class="input-text "
						style="width:25%"> 人——上限 <input type="text"
						name="numUper" id="numUper" placeholder="10-500之间" value="${editActivity.upperLimit}"
						class="input-text " style=" width:25%"> 人
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>活动封面图片：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<div id="imgDiv"><img id="imgPreview" name="imgPreview" src="${editActivity.coverImageUrl}" height="150" width="150" /></div>
					<div id="picker" name="picker">选择封面图片</div>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>活动描述：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="describe" id="describe" cols="" rows=""
						class="textarea" placeholder="活动描述...100个字符以内" dragonfly="true"
						onKeyUp="$.Huitextarealength(this,100)">${editActivity.activitiesDescribe}</textarea>
	...
	<script type="text/javascript">
		$(function() {
			 $("#activityTypes option").each(function (){  
		            ...
		            if(typeVal=='${editActivity.activitiesTypeId}'){  
		            	$(this).attr("selected",true); //设置当前活动类型
		            }  
		    });  
			...
			$("#form-activitySpace-edit").validate({
					rules : {
						...
						numLower:{
							required:true,
							digits:true,//输入整数
							range:[0,20]//0-10之间的数字
						},
						numUper:{
							required:true,
							digits:true,//输入整数
							range:[20,500]//10-500之间的数字
						},
						imgURL:{
							required:true,
						},
					...
					submitHandler : function(form) {
						if(window.confirm('确定要修改活动信息吗？')){
						var url = 'editActivity.action?activitiesId=${editActivity.activitiesId}';
						$(form).ajaxSubmit({
							type : 'post',
							url : url,
